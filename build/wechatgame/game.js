...
const importMap = require("src/import-map.e6725.js").default;
System.warmup({
    importMap,
    importMapUrl: 'src/import-map.e6725.js',
...
function onApplicationCreated(application) {
    return System.import('cc').then((module) => {
        ...
        require('./engine-adapter.1eea2.js');
