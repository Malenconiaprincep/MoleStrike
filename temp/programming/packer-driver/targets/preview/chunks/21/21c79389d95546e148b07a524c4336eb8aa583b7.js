    ...
    execute: function () {
      ...
      _export("AutoGameBootstrap", AutoGameBootstrap = (_dec = ccclass('AutoGameBootstrap'), _dec(_class = executeInEditMode(_class = (_class2 = class AutoGameBootstrap extends Component {
        ...
        buildGame() {
          ...
          var resumeButton = this.createButton('ResumeButton', '继续游戏', new Color(255, 184, 65, 255), () => {
        ...
        buildGamePanel(gamePanel, gameManager, moleManager) {
          ...
          var pauseButton = this.createIconButton('PauseButton', (_crd && ArtAssetKey === void 0 ? (_reportPossibleCrUseOfArtAssetKey({
            error: Error()
        ...
        buildResultPanel(resultPanel, gameManager, audioManager, leaderboardPanel, leaderboardFallback) {
          ...
          var leaderboardButton = this.createButton('LeaderboardButton', '排行榜', new Color(141, 205, 255, 255), () => {
            ...
            var available = (_crd && PlatformAdapter === void 0 ? (_reportPossibleCrUseOfPlatformAdapter({
              error: Error()
        ...
        buildLeaderboardPanel(panel, audioManager) {
          ...
          var closeButton = this.createButton('LeaderboardCloseButton', '关闭', new Color(122, 190, 91, 255), () => {
            audioManager.playButtonClick();
        ...
        createButton(name, text, color, onClick, width, height, fontSize, artKey) {
          if (width === void 0) {
            width = 300;
          }
