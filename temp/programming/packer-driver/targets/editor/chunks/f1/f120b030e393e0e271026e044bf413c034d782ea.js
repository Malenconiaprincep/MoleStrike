    ...
    execute: function () {
      ...
      _export("PlatformAdapter", PlatformAdapter = class PlatformAdapter {
          ...
          this.loginPromise = new Promise(resolve => {
            api.login == null || api.login({
              ...
              success: result => {
                ...
                const code = (_ref = (_result$code = result.code) != null ? _result$code : result.anonymousCode) != null ? _ref : '';
                resolve({
                  platform,
        ...
        static showLeaderboard() {
          ...
          const openDataContext = (_this$getActiveApi = this.getActiveApi()) == null || _this$getActiveApi.getOpenDataContext == null ? void 0 : _this$getActiveApi.getOpenDataContext();
        ...
        static submitScore(score) {
          ...
          const openDataContext = api == null || api.getOpenDataContext == null ? void 0 : api.getOpenDataContext();
        ...
        static registerErrorHandlers(handler) {
          ...
          api == null || api.onError == null || api.onError(error => {
            ...
            const message = typeof error === 'string' ? error : (_error$errMsg2 = error.errMsg) != null ? _error$errMsg2 : 'unknown runtime error';
            handler('runtime', message);
          });
          api == null || api.onUnhandledRejection == null || api.onUnhandledRejection(result => {
            const reason = result.reason;
            const message = reason instanceof Error ? reason.message : String(reason != null ? reason : 'unknown rejection');
