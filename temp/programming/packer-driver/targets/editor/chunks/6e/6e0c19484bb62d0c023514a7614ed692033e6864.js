      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(_crd && ScoreManager === void 0 ? (_reportPossibleCrUseOfScoreManager({
        ...
        startGame(source = 'home') {
          ...
          (_this$moleManager2 = this.moleManager) == null || _this$moleManager2.startSpawning((score, hit, target) => {
            ...
            const combo = score > 0 ? (_this$comboManager$ad = (_this$comboManager3 = this.comboManager) == null ? void 0 : _this$comboManager3.addCombo()) != null ? _this$comboManager$ad : 0 : 0;
        ...
        finishGame() {
          ...
          const finalScore = (_this$scoreManager$ge = (_this$scoreManager4 = this.scoreManager) == null ? void 0 : _this$scoreManager4.getScore()) != null ? _this$scoreManager$ge : 0;
          const previousBestScore = (_crd && StorageManager === void 0 ? (_reportPossibleCrUseOfStorageManager({
            error: Error()
