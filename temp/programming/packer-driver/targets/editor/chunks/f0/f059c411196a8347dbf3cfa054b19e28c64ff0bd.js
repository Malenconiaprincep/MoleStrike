  ...
  return {
    ...
    execute: function () {
      ...
      _export("UIManager", UIManager = (_dec = ccclass('UIManager'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(Label), _dec12 = property(Label), _dec(_class = (_class2 = class UIManager extends Component {
        ...
        showResult(finalScore, bestScore = finalScore, isNewRecord = false, rating = '') {
          this.setActive(this.homePanel, false);
          this.setActive(this.gamePanel, false);
        ...
        showPauseMask(show) {
          ...
          const opacity = (_this$pauseMask$getCo = this.pauseMask.getComponent(UIOpacity)) != null ? _this$pauseMask$getCo : this.pauseMask.addComponent(UIOpacity);
        ...
        showDailyChallenge(snapshot, justCompleted = false) {
          const text = (_crd && DailyChallengeManager === void 0 ? (_reportPossibleCrUseOfDailyChallengeManager({
            error: Error()
        ...
        playResultEntrance(isNewRecord) {
          ...
          const opacity = (_this$resultPanel$get = this.resultPanel.getComponent(UIOpacity)) != null ? _this$resultPanel$get : this.resultPanel.addComponent(UIOpacity);
